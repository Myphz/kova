...
mv app/build/outputs/bundle/release/app-release.aab ../bundle/kova-unsigned.aab

# Sign bundle
cd ../bundle
jarsigner -sigalg SHA256withRSA -digestalg SHA-256 -keystore ~/keys/kova.keystore -signedjar kova.aab kova-unsigned.aab kova
rm kova-unsigned.aab
